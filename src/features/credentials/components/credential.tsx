...
export const CredentialForm = ({
    ...
    const updateCredetial = useUpdateCredential();
    ...
    const onSubmit = async (values: FormValues) => {
        if (isEdit && initialData?.id) {
            await updateCredetial.mutateAsync({
                id: initialData.id,
                ...values,
            })
        } else {
...
export const CredentialView = ({ credentialId }: { credentialId: string }) => {
    ...
    // Map Prisma type to form type
    const initialData = credential
        ? {
            id: credential.id,
            name: credential.name,
            type: credential.type,
            value: (credential as any).value || "", // fallback if value may not be typed
        }
        : undefined;
